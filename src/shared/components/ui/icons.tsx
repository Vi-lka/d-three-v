...
export const Icons = {
  ...
  google: (props: SVGProps<SVGSVGElement>) => <FaGoogle {...props} />,
  ...
  map: (props: SVGProps<SVGSVGElement>) => <MapIcon {...props} />,
  table: (props: SVGProps<SVGSVGElement>) => <Table2 {...props} />,
};
...
export function IconByName(props: IconByNameProps) {
  ...
  switch (iconName) {
    ...
    case "yandex":
      return <Icons.yandex {...rest} />;
    case "vk":
      return <Icons.vk {...rest} />;
    case "map":
      return <Icons.map {...rest} />;
    case "table":
      return <Icons.table {...rest} />;
    case "spinner":
      return <Icons.spinner {...rest} />;
    default:
      return null;
  }
}
